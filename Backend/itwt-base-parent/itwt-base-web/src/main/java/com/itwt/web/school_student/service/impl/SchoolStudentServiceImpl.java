package com.itwt.web.school_student.service.impl;
...
import com.itwt.web.school_student.mapper.SchoolStudentMapper;
import com.itwt.web.school_student.service.SchoolStudentService;
import com.itwt.web.stu_role.entity.StuRole;
import com.itwt.web.stu_role.service.StuRoleService;
...
public class SchoolStudentServiceImpl extends ServiceImpl<SchoolStudentMapper, SchoolStudent> implements SchoolStudentService {
    ...
    public void editStu(SchoolStudent schoolStudent) {
        ...
        if (i>0){
            //先删除，再插入
            LambdaQueryWrapper<StuRole> queryWrapper = new LambdaQueryWrapper<>();
            queryWrapper.eq(StuRole::getStuId,schoolStudent.getStuId());
    ...
    public void deleteStu(Long studId) {
        ...
        if (i>0){
            LambdaQueryWrapper<StuRole> queryWrapper = new LambdaQueryWrapper<>();
            queryWrapper.eq(StuRole::getStuId,studId);
            stuRoleService.remove(queryWrapper);
        }
    }
