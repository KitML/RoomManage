package com.itwt.web.sys_notice.controller;
...
import com.itwt.utils.Utils;
import com.itwt.web.sys_notice.entity.NoticeParm;
import com.itwt.web.sys_notice.entity.SysNotice;
import com.itwt.web.sys_notice.service.SysNoticeService;
...
public class SysNoticeController {
    ...
    public ResultVo list(NoticeParm parm){
        ...
        if(StringUtils.isNotEmpty(parm.getNoticeTitle())){
            query.like(SysNotice::getNoticeTitle,parm.getNoticeTitle());
        }
