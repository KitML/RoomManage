package com.itwt.web.school_student.controller;
...
import com.itwt.web.school_student.entity.StuExcel;
import com.itwt.web.school_student.entity.StuExport;
...
public class SchoolStudentController {
    ...
    public ResultVo getClassList(Long major) {
        LambdaQueryWrapper<SchoolClass> query = new LambdaQueryWrapper<>();
        query.eq(SchoolClass::getMajorId, major);
