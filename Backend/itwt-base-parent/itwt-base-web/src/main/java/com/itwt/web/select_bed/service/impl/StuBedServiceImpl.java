package com.itwt.web.select_bed.service.impl;

import com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper;
import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.itwt.web.assign_bed.entity.AssignBed;
...
import com.itwt.web.select_bed.mapper.StuBedMapper;
...
public class StuBedServiceImpl extends ServiceImpl<StuBedMapper, StuBed> implements StuBedService {
    ...
    public void clearBed(Long classId) {
        ...
        queryWrapper.eq(AssignBed::getClassId,classId);
        assignBedService.remove(queryWrapper);
        //清空学生选择的表
        QueryWrapper<SchoolStudent> wrapper = new QueryWrapper<>();
        wrapper.lambda().eq(SchoolStudent::getClassId,classId);
        List<SchoolStudent> list = schoolStudentService.list(wrapper.select("stu_id"));
        ...
        LambdaQueryWrapper<StuBed> qs = new LambdaQueryWrapper<>();
        qs.in(StuBed::getStuId,ids);
